...
Una misma ficha puede pertenecer a varios dominios. Por ello, estas cifras no deben sumarse para obtener el total único.

| Dominio | Registros vinculados | Subdominios |
| --- | ---: | ---: |
...
Cada ministerio tiene una ficha propia bajo Política y una función adicional en otro dominio. No se confunden con secretarías, superintendencias o instrumentos. Se eligieron siete por su relación documentada con formación, actividad productiva, trámites o mercados; no se trata de un inventario completo del Organismo Ejecutivo.

| Ministerio | Función documentada en el ecosistema | Fuente oficial |
| --- | --- | --- |
| Ministerio de Economía (MINECO) | Apoya la competitividad de las MIPYMES mediante su viceministerio y servicios de desarrollo empresarial y financieros. | [MINECO · Viceministerio MIPYME](https://www.mineco.gob.gt/institucion/viceministerio-de-desarrollo-de-la-mipyme) |
| Ministerio de Trabajo y Previsión Social (MINTRAB) | Participa en el fortalecimiento de servicios de empleo, formación laboral y tránsito a la formalidad descritos por el Programa Trabajo Decente. | [MINECO · Programa Trabajo Decente](https://www.mineco.gob.gt/institucion/viceministerio-de-desarrollo-de-la-mipyme/programa-trabajo-decente) |
| Ministerio de Educación (MINEDUC) | Desarrolla el marco curricular nacional. Su conexión con el emprendimiento se concreta en las áreas educativas de productividad y emprendimiento. | [MINEDUC · Currículo Nacional Base](https://digecur.mineduc.gob.gt/curriculo-nacional-base-cnb/) |
| Ministerio de Agricultura, Ganadería y Alimentación (MAGA) | Por medio de la extensión rural y los CADER, ofrece aprendizaje y asesoría para transformar excedentes agrícolas en productos con valor agregado. | [MAGA · CADER y emprendimientos locales](https://www.maga.gob.gt/cader-espacios-de-aprendizaje-que-transforman-el-campo-guatemalteco/) |
| Ministerio de Finanzas Públicas (MINFIN) | Se incorpora por su relación con las compras públicas: Guatecompras presenta información y consultas de proveedores a través de la Dirección General de Adquisiciones del Estado. | [MINFIN · Guatecompras y proveedores](https://www.guatecompras.gt/proveedores/busquedaProvee.aspx) |
| Ministerio de Ambiente y Recursos Naturales (MARN) | Se incorpora por la gestión de instrumentos y licencias ambientales aplicables a proyectos y actividades productivas. | [MARN · Instrumentos ambientales](https://marn.gob.gt/instrumentos-ambientales/) |
| Ministerio de Salud Pública y Asistencia Social (MSPAS) | Se incorpora por los trámites de licencias de fábricas de alimentos y registros sanitarios que presenta el sistema SNAP-GT. | [MSPAS · Sistema Nacional de Alimentos Procesados](https://www.mspas.gob.gt/sistema-snap-gt) |

## Currículum Nacional Base

El **CNB es un instrumento curricular de MINEDUC**, no una institución. Su ficha pertenece a educación, talento y gobernanza educativa. La aplicación muestra un rombo para distinguir instrumentos y permite navegar desde el CNB hasta MINEDUC mediante un vínculo explícito.

Se incorporan dos áreas curriculares como registros propios: **Productividad y Desarrollo · primaria** y **Emprendimiento para la Productividad · Ciclo Básico**. Ambas remiten al CNB. No se afirma que cada centro educativo implemente el currículo de la misma manera, ni se extiende una malla de un nivel a todos los niveles.

Fuentes: [portal oficial del CNB](https://digecur.mineduc.gob.gt/curriculo-nacional-base-cnb/), [Departamento de Nivel Medio, Ciclo Básico](https://digecur.mineduc.gob.gt/departamentos/nivel-medio-ciclo-basico/) y [CNB de sexto primaria](https://edu.mineduc.gob.gt/DIGECUR/documents/CNB/CNB_TODOS_LOS_NIVELES/2-PDF_CNB_PRIMARIA/CNB-Nivel-de-Educacion-Primaria-CICLO-II/6.%20CNB_6to_grado.pdf).

## Criterios de integración

- **Sin cupos por dominio.** Todas las entradas del mapa base están representadas en una ficha o en la evidencia de una ficha normalizada.
- **Identidad y función separadas.** Universidades, centros, programas y documentos se distinguen. KEC, CREA, CEL y DIGI no se cuentan simplemente como sinónimos de sus universidades.
- **Pertenencia múltiple.** Un registro puede aparecer en varios dominios y subdominios sin duplicar su identidad en el catálogo.
- **Adaptación del modelo.** Capital humano del mapa base se distribuye entre educación, talento e investigación; las funciones restantes mantienen su equivalencia con los ocho dominios de la aplicación.
- **Vínculos explícitos.** Se registran algunas relaciones de unidad institucional o de instrumento con su entidad responsable (por ejemplo CNB–MINEDUC). No se deducen alianzas ni transferencias de recursos a partir de la cercanía visual.
- **Tipos editoriales.** La naturaleza del registro se clasifica para navegar. Cuando un renglón combina varias entidades, se conserva como referencia compuesta y no aumenta el conteo de instituciones individuales.
- **Documentos duplicados.** Los dos PDF de Daniel Monroy y Javier García tienen el mismo SHA-256 y cuentan como un trabajo. La presentación de Nuria y Diego es la versión disponible en esta carpeta del contenido leído anteriormente también en PDF. Se migraron sus referencias a diapositivas de la presentación.
- **Recurrencia no es importancia.** La interfaz indica mapas citados, no un ranking ni un conteo exhaustivo de todas las menciones en todos los documentos. Los aportes oficiales se contabilizan por separado.

## Alcance geográfico y temporal

El documento base se refiere a **Ciudad de Guatemala** y contiene organizaciones de alcance nacional e internacional. Las ampliaciones añaden referencias nacionales y rurales, pero esta compilación no es un censo equilibrado de los 22 departamentos. La aparición de un programa en un mapa estudiantil no prueba que tenga convocatoria abierta hoy. Las entradas normativas se conservan como referencias documentales, sin convertirlas en asesoramiento legal o afirmar una vigencia revisada.

Las funciones de los siete ministerios y del CNB se complementaron con fuentes oficiales consultadas en esta iteración. No se ha verificado individualmente la oferta actual de los otros registros. En particular, se conservan referencias históricas a cooperación y USAID como menciones del documento, no como promesa de servicios disponibles.

## Exploración de la aplicación

1. Selecciona un dominio para acceder a todos sus registros.
2. Selecciona un subdominio visible para desplegar sus registros. Puedes filtrar por naturaleza y regresar con la ruta del panel.
3. Usa Anterior / Siguiente para recorrer el resultado. Se dibujan ocho registros por página para mantener separación geométrica; no se eliminan los demás del catálogo.
4. La búsqueda recorre todo el ecosistema por nombre, alias, tipo, palabras clave y subdominio; admite texto sin tildes.
5. Selecciona una ficha para consultar sus funciones, dominios, vínculos explícitos y fuentes. Los PDF se abren en la página citada, las presentaciones se enlazan como archivo y las fuentes oficiales abren sus sitios.
6. Restablecer cierra el catálogo y recupera las posiciones iniciales. El centro nunca admite arrastre; pan y zoom transforman el mapa completo.
...
- **F6** · [Stefani y Paulo](fuentes/MAPEO%20ACTORES%20Stefani%20&%20Paulo.pdf) · mapa.
- **BASE** · [Mapa de referencia · Ciudad de Guatemala](fuentes/Ecosistema%20de%20Emprendimiento%20de%20la%20Ciudad%20de%20Guatemala%20(PDF%20vectorial).pdf) · mapa.
- **OTRO** · [Ortíz, Monzón y Bián · Mapa del ecosistema](fuentes/Mapa%20de%20Ecosistema%20de%20los%20Emprendimientos%20en%20Guatemala.pdf) · mapa.
- **O1** · [MINECO · Viceministerio MIPYME](https://www.mineco.gob.gt/institucion/viceministerio-de-desarrollo-de-la-mipyme) · oficial.
- **O2** · [MINEDUC · Currículo Nacional Base](https://digecur.mineduc.gob.gt/curriculo-nacional-base-cnb/) · oficial.
- **O3** · [MINEDUC · Nivel Medio, Ciclo Básico](https://digecur.mineduc.gob.gt/departamentos/nivel-medio-ciclo-basico/) · oficial.
- **O4** · [MINECO · Programa Trabajo Decente](https://www.mineco.gob.gt/institucion/viceministerio-de-desarrollo-de-la-mipyme/programa-trabajo-decente) · oficial.
- **O5** · [MAGA · CADER y emprendimientos locales](https://www.maga.gob.gt/cader-espacios-de-aprendizaje-que-transforman-el-campo-guatemalteco/) · oficial.
- **O6** · [MINFIN · Guatecompras y proveedores](https://www.guatecompras.gt/proveedores/busquedaProvee.aspx) · oficial.
- **O7** · [MARN · Instrumentos ambientales](https://marn.gob.gt/instrumentos-ambientales/) · oficial.
- **O8** · [MSPAS · Sistema Nacional de Alimentos Procesados](https://www.mspas.gob.gt/sistema-snap-gt) · oficial.
- **O9** · [MINEDUC · Productividad y Desarrollo, sexto primaria](https://edu.mineduc.gob.gt/DIGECUR/documents/CNB/CNB_TODOS_LOS_NIVELES/2-PDF_CNB_PRIMARIA/CNB-Nivel-de-Educacion-Primaria-CICLO-II/6.%20CNB_6to_grado.pdf) · oficial.

## Trazabilidad y verificación

`data/seleccion-actores.json` contiene `cobertura_base`: 355 entradas con nombre original, dominio, subdominio e identificador de la ficha resultante. Se comprueba que cada entrada tenga su evidencia exacta en la ficha. `inventario_fuentes` conserva las huellas SHA-256 para identificar duplicados.
...
| Registro | Tipo | Dominios |
| --- | --- | --- |
| #GuatemalaGives (Fundación Tigo + HIP) | Programa / iniciativa | Sector financiero e inversión |
...
| BCIE – DINAMICA II (UE + KfW) | Programa / servicio | Sector financiero e inversión |
| BCIE – líneas MIPYME | Programa / servicio | Sector financiero e inversión |
| BID / BID Lab | Referencia compuesta | Política, regulación y gobernanza |
| BID Invest | Entidad / red / empresa | Política, regulación y gobernanza |
| BID Lab | Entidad / red / empresa | Sector financiero e inversión |
| Banco CHN | Entidad / red / empresa | Sector financiero e inversión |
| Banco G&T Continental | Entidad / red / empresa | Sector financiero e inversión |
| Banco Industrial | Banco | Sector corporativo, mercados y demanda; Sector financiero e inversión |
| Banco Promerica | Entidad / red / empresa | Sector financiero e inversión |
| Banco de Guatemala | Entidad / red / empresa | Política, regulación y gobernanza |
| Banco de los Trabajadores (Bantrab) | Entidad / red / empresa | Sector financiero e inversión |
| Banrural | Entidad / red / empresa | Sector financiero e inversión |
| Banrural – Amigo Paisano | Programa / servicio | Sector corporativo, mercados y demanda |
| Banrural – Crédito Amigo Remesas | Programa / servicio | Sector corporativo, mercados y demanda |
...
| Emprendimiento para la Productividad · CNB Ciclo Básico | Área curricular | Sistema educativo |
| Empréndete G100 | Evento / competencia | Cultura, comunidades y modelos de rol |
| Enactus Guatemala | Red educativa | Talento humano; Cultura, comunidades y modelos de rol |
...
| FUNDAP – Microcrédito | Programa / servicio | Sector financiero e inversión |
| FUNDEA | Entidad / red / empresa | Sector financiero e inversión |
| FUNDES – GEDI | Programa / servicio | Sector financiero e inversión |
| FUNDESA | Entidad / red / empresa | Política, regulación y gobernanza |
| FUNDESA – Guatemala No Se Detiene | Programa / servicio | Política, regulación y gobernanza |
| FUNSEPA | Entidad / red / empresa | Talento humano |
| Fab Lab USAC (DIGI) | Centro / unidad institucional | Investigación, desarrollo e innovación |
| FabLab – Universidad Rafael Landívar | Centro / unidad institucional | Investigación, desarrollo e innovación |
| Fablab Centro TICS – INTECAP | Centro / unidad institucional | Investigación, desarrollo e innovación |
| Fe y Alegría Guatemala | Entidad / red / empresa | Talento humano |
| Feria de Emprendimiento MINECO–USAC | Evento / competencia | Cultura, comunidades y modelos de rol |
...
| GIZ (CaPAZ II, EDUVIDA II) | Entidad / red / empresa | Política, regulación y gobernanza |
| Galardón Nacional a la Exportación | Evento / competencia | Sector corporativo, mercados y demanda |
...
| Hecho en Guate (CMI / Pradera) | Programa / servicio | Sector corporativo, mercados y demanda |
| Hult Prize On Campus – UNIS | Evento / competencia | Cultura, comunidades y modelos de rol |
| Hult Prize On Campus – UVG | Evento / competencia | Cultura, comunidades y modelos de rol |
| ICC One Click (CIG) | Programa / iniciativa | Sector corporativo, mercados y demanda |
| IDC Ventures | Entidad / red / empresa | Sector financiero e inversión |
...
| InspireMe.Fund Guatemala | Fondo / mecanismo de financiamiento | Sector financiero e inversión |
| InterBanco – Factoraje Digital | Programa / servicio | Sector financiero e inversión |
| Interfer – Pabellón MIPYME de Corazón | Evento / competencia | Sector corporativo, mercados y demanda |
| Invariantes | Organización de inversión | Sector financiero e inversión |
| Invest Guatemala | Entidad / red / empresa | Sector corporativo, mercados y demanda; Política, regulación y gobernanza |
...
| Ley de Emprendimiento (Dto. 20-2018) | Instrumento / marco normativo | Política, regulación y gobernanza |
| Ley de Factoraje y Descuento (Dto. 1-2018) | Instrumento / marco normativo | Política, regulación y gobernanza |
| Ley de Garantías Mobiliarias (Dto. 51-2007) | Instrumento / marco normativo | Política, regulación y gobernanza |
| Ley de Leasing (Dto. 2-2021) | Instrumento / marco normativo | Política, regulación y gobernanza |
| Ley de Simplificación Tributaria (Dto. 7-2019) | Instrumento / marco normativo | Política, regulación y gobernanza |
| Ley de Simplificación de Trámites (Dto. 5-2021) | Instrumento / marco normativo | Política, regulación y gobernanza |
| Losa Group | Entidad / red / empresa | Sector financiero e inversión |
| Loyal VC | Entidad / red / empresa | Sector financiero e inversión |
| MINECO – Cadenas de Valor | Programa / servicio | Sector corporativo, mercados y demanda |
| MINECO – DACE | Programa / servicio | Sector corporativo, mercados y demanda |
| MINECO – Ferias y Encuentros Comerciales | Evento / competencia | Sector corporativo, mercados y demanda |
| MINECO – MIPYME Exporta | Programa / servicio | Sector corporativo, mercados y demanda |
| MINECO – MIPYME Proveedora del Estado | Programa / servicio | Sector corporativo, mercados y demanda |
| MINECO – Unidad de Emprendimiento | Centro / unidad institucional | Política, regulación y gobernanza |
| MINECO – Viceministerio de la MIPYME | Centro / unidad institucional | Política, regulación y gobernanza |
| Maestría en Emprendimiento – UMG | Programa / servicio | Sistema educativo |
| Maestría en Innovación – U. Galileo | Programa / servicio | Sistema educativo |
| Makerspace D-Hive – UVG | Centro / unidad institucional | Investigación, desarrollo e innovación |
...
| OIM – Fondo de Desarrollo Empresarial | Programa / servicio | Sector corporativo, mercados y demanda |
...
| SAT | Entidad / red / empresa | Política, regulación y gobernanza |
| SAT – Agencia Virtual | Plataforma / trámite | Política, regulación y gobernanza |
| SENACYT | Institución pública | Política, regulación y gobernanza; Investigación, desarrollo e innovación |
...
| Summit G100 | Evento / competencia | Cultura, comunidades y modelos de rol |
| Superintendencia de Bancos | Entidad / red / empresa | Política, regulación y gobernanza |
| Swisscontact Guatemala | Entidad / red / empresa | Talento humano |
| TEC-Landívar | Centro / unidad institucional | Investigación, desarrollo e innovación |
...
| USAID – GEDI | Programa / servicio | Política, regulación y gobernanza |
...
| Universidad Francisco Marroquín (UFM) | Universidad | Sistema educativo |
| Universidad Galileo | Organización | Sistema educativo |
| Universidad Mariano Gálvez | Organización | Sistema educativo |
| Universidad Rafael Landívar (URL) | Universidad | Sistema educativo |
| Universidad del Valle de Guatemala (UVG) | Universidad | Sistema educativo |
| Unión Aduanera CA – FYDUCA (SAT) | Plataforma / trámite | Sector corporativo, mercados y demanda |
...
| Win.gt | Medio | Cultura, comunidades y modelos de rol |
| Wonder Woman Guatemala | Entidad / red / empresa | Cultura, comunidades y modelos de rol; Talento humano |
| Yo Emprendo x Guate (CIG + JA) | Evento / competencia | Cultura, comunidades y modelos de rol |
| ZOLIC – régimen ZDEEP | Programa / servicio | Sector corporativo, mercados y demanda |
